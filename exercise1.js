...
const showOneSuperHero = (aka) => {
    if(aka in infoSuperheroes){
        const information = infoSuperheroes[aka]

        console.log(`${aka}`, information)
   
    }else{
        console.log(`The super Hero ${aka} not exist`)
    }
    
     }

const showAllSuperHeros = (akas) => {
    
    akas.forEach(nombre => {
        showOneSuperHero(nombre)
    });
    
}
showAllSuperHeros(["Hulk", "Iron Man", "Batman"])
